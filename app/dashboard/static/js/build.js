...
({
    ...
    map: {
        '*': {
            ...
            'app/view-builds-id': 'app/view-builds-id.2020.9',
            'app/view-builds-job-branch-kernel': 'app/view-builds-job-branch-kernel.2020.9',
            ...
            'app/view-jobs-all': 'app/view-jobs-all.2020.9',
            'app/view-jobs-job': 'app/view-jobs-job.2020.9',
            'app/view-jobs-job-branch': 'app/view-jobs-job-branch.2020.9',
            ...
            'app/view-socs-soc-job-kernel': 'app/view-socs-soc-job-kernel.2020.9',
            'app/view-socs-soc-job-kernel-plan': 'app/view-socs-soc-job-kernel-plan.2020.9',
            ...
            'app/view-tests-plan-id': 'app/view-tests-plan-id.2020.9',
            'app/view-tests-case-id': 'app/view-tests-case-id.2020.9',
            'app/view-tests-job-branch-kernel': 'app/view-tests-job-branch-kernel.2020.9',
            'app/view-tests-job-branch-kernel-plan': 'app/view-tests-job-branch-kernel-plan.2020.9',
        }
    },
    shim: {
    ...
    modules: [
        ...
        {name: 'app/view-builds-id.2020.9'},
        {name: 'app/view-builds-job-branch-kernel.2020.9'},
        ...
        {name: 'app/view-jobs-all.2020.9'},
        {name: 'app/view-jobs-job-branch.2020.9'},
        {name: 'app/view-jobs-job.2020.9'},
        {name: 'app/view-socs-all.2020.5'},
        {name: 'app/view-socs-soc-job-kernel-plan.2020.9'},
        {name: 'app/view-socs-soc-job-kernel.2020.9'},
        {name: 'app/view-socs-soc-job.2020.5'},
        {name: 'app/view-socs-soc.2020.6'},
        {name: 'app/view-sponsors.2017.3.3'},
        {name: 'app/view-stats.2017.3.3'},
        {name: 'app/view-tests-all.2020.9'},
        {name: 'app/view-tests-plan-id.2020.9'},
        {name: 'app/view-tests-case-id.2020.9'},
        {name: 'app/view-tests-job-branch-kernel.2020.9'},
        {name: 'app/view-tests-job-branch-kernel-plan.2020.9'},
        {name: 'kci-builds-all'},
        {name: 'kci-builds-id'},
