...
({
    ...
    map: {
        '*': {
            ...
            'app/view-builds-id': 'app/view-builds-id.2020.6',
            'app/view-builds-job-branch-kernel': 'app/view-builds-job-branch-kernel.2020.6',
            ...
            'app/view-jobs-all': 'app/view-jobs-all.2020.5',
            ...
            'app/view-tests-all': 'app/view-tests-all.2020.5',
            'app/view-tests-plan-id': 'app/view-tests-plan-id.2020.6',
            'app/view-tests-case-id': 'app/view-tests-case-id.2020.6',
            'app/view-tests-job-branch-kernel': 'app/view-tests-job-branch-kernel.2020.6',
            'app/view-tests-job-branch-kernel-plan': 'app/view-tests-job-branch-kernel-plan.2020.6',
        }
    },
    shim: {
    ...
    modules: [
        ...
        {name: 'app/view-builds-id.2020.6'},
        {name: 'app/view-builds-job-branch-kernel.2020.6'},
        ...
        {name: 'app/view-jobs-all.2020.5'},
        {name: 'app/view-jobs-job-branch.2020.5'},
        {name: 'app/view-jobs-job.2020.5'},
        ...
        {name: 'app/view-tests-all.2020.5'},
        {name: 'app/view-tests-plan-id.2020.6'},
        {name: 'app/view-tests-case-id.2020.6'},
        {name: 'app/view-tests-job-branch-kernel.2020.6'},
        {name: 'app/view-tests-job-branch-kernel-plan.2020.6'},
        {name: 'kci-builds-all'},
        {name: 'kci-builds-id'},
