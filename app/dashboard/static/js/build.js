...
({
    ...
    map: {
        '*': {
            ...
            'app/view-builds-job-kernel': 'app/view-builds-job-kernel.2020.5',
            ...
            'app/view-tests-plan-id': 'app/view-tests-plan-id.2020.5',
            'app/view-tests-case-id': 'app/view-tests-case-id.2020.5',
            'app/view-tests-job-branch-kernel': 'app/view-tests-job-branch-kernel.2020.5',
            'app/view-tests-job-branch-kernel-plan': 'app/view-tests-job-branch-kernel-plan.2020.5',
        }
    },
    shim: {
    ...
    modules: [
        ...
        {name: 'app/view-builds-job-kernel.2020.5'},
        ...
        {name: 'app/view-socs-soc-job-kernel-plan.2020.5'},
        {name: 'app/view-socs-soc-job-kernel.2020.5'},
        ...
        {name: 'app/view-tests-plan-id.2020.5'},
