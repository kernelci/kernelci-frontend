({
    ...
    map: {
        '*': {
            ...
            'app/view-boots-job-kernel': 'app/view-boots-job-kernel.20150717',
            'app/view-builds-all': 'app/view-builds-all.20150717',
            'app/view-builds-job-kernel': 'app/view-builds-job-kernel.20150717',
            'app/view-builds-job-kernel-defconfig': 'app/view-builds-job-kernel-defconfig.20150717',
            'app/view-builds-job-kernel-defconfig-logs': 'app/view-builds-job-kernel-defconfig-logs.20150717',
            'app/view-index': 'app/view-index.20150717',
            'app/view-info-faq': 'app/view-info-faq.20150702',
            'app/view-jobs-all': 'app/view-jobs-all.20150717',
            'app/view-jobs-job': 'app/view-jobs-job.20150717',
            'app/view-jobs-job-branch': 'app/view-jobs-job-branch.20150717',
    ...
    modules: [
        ...
        {name: 'app/view-boots-job-kernel.20150717'},
        {name: 'app/view-builds-all.20150717'},
        {name: 'app/view-builds-job-kernel-defconfig-logs.20150717'},
        {name: 'app/view-builds-job-kernel-defconfig.20150717'},
        {name: 'app/view-builds-job-kernel.20150717'},
        {name: 'app/view-index.20150717'},
        {name: 'app/view-info-faq.20150702'},
        {name: 'app/view-jobs-all.20150717'},
        {name: 'app/view-jobs-job-branch.20150717'},
        {name: 'app/view-jobs-job.20150717'},
        {name: 'kci-boots-all'},
