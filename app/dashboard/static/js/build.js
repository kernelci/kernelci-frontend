({
    ...
    modules: [
        {name: 'app/view-boots-all-job-kernel-defconfig.20158'},
        {name: 'app/view-boots-all-job.20158'},
        {name: 'app/view-boots-all-lab.20158'},
        {name: 'app/view-boots-all.20158'},
        {name: 'app/view-boots-board-job-kernel-defconfig.20158'},
        {name: 'app/view-boots-board-job-kernel.20158'},
        {name: 'app/view-boots-board-job.20158'},
        {name: 'app/view-boots-board.20158'},
        {name: 'app/view-boots-id.20158'},
        {name: 'app/view-boots-job-kernel.20158'},
        {name: 'app/view-builds-all.20158'},
        {name: 'app/view-builds-job-kernel-defconfig-logs.20158'},
        {name: 'app/view-builds-job-kernel-defconfig.20158'},
        {name: 'app/view-builds-job-kernel.20158'},
        {name: 'app/view-index.20158'},
        {name: 'app/view-info-faq.20158'},
