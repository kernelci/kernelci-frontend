...
require.config({
    ...
    map: {
        '*': {
            ...
            'app/view-builds-job-branch-kernel': 'app/view-builds-job-branch-kernel.2017.3.4',
            ...
            'app/view-job-compare': 'app/view-job-compare.2017.3.4',
            'app/view-jobs-all': 'app/view-jobs-all.2017.3.4',
            'app/view-jobs-job': 'app/view-jobs-job.2017.3.4',
            'app/view-jobs-job-branch': 'app/view-jobs-job-branch.2017.3.4',
